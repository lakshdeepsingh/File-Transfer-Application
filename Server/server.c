// File Transfer application by Lakshdeep Singh and Birajkumar Patel
...
// global vars
char rootDir[] = "./FileStorage/";

// custom flags
char getAction[] = "-1";
char putAction[] = "-2";
char fileFoundAction[] = "-1";
char fileNotFoundAction[] = "-2";
char ack[] = "-ack";

// custom messages
char exitMsg[] = "quit\n";
char wellcomeMsg[] = "Welcome to our File Server!\n\n=========================================\nValid commands :\n\n > get <fileName> - To download a file from server to client,\n > put <filename> - To upload a file from client to server\n > quit - To exit\n========================================================";
char errorMsg[] = "Invalid command, please try again!";
char foundMsg[] = "The file has been found!";
char notFoundMsg[] = "Sorry, file not found!";
char downloadMsg[] = "Please wait, downloading the file!";
